...
HD_PWD='C:/ProgH/SpiTest/SpiTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_slave_16bit.tcl
