...
#
# Script generated by Vivado on Wed Apr 09 19:26:55 +0200 2025
...
# script info
echo -e "blk_mem_gen_17.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_17 xil_defaultlib.blk_mem_gen_17 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_17 -key {Behavioral:sim_1:Functional:blk_mem_gen_17} -tclbatch cmd.tcl -log simulate.log
}
