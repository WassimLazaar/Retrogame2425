...
#
# Script generated by Vivado on Fri Apr 04 15:00:42 +0200 2025
...
# script info
echo -e "blk_mem_gen_9.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_9 xil_defaultlib.blk_mem_gen_9 xil_defaultlib.glbl -log elaborate.log
}
