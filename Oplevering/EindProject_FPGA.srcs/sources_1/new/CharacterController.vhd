...
architecture Behavioral of CharacterController is
    ...
    signal CharacterMove      : std_logic := '0';

begin

    -- Instantieer de ControlCharacter-module
    ControlChar_inst : ControlCharacter
        port map (
    ...
    begin
        if rising_edge(clk) then
            ...
            if slow_pulse = '1' and CharacterMove = '1' then
