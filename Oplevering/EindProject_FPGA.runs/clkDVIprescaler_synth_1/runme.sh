...
HD_PWD='C:/Progh/Code/Project_RetroGame/Oplevering/EindProject_FPGA.runs/clkDVIprescaler_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkDVIprescaler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkDVIprescaler.tcl
