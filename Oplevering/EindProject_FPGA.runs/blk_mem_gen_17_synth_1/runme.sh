...
HD_PWD='C:/Progh/Code/Project_RetroGame/Oplevering/EindProject_FPGA.runs/blk_mem_gen_17_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_17.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_17.tcl
