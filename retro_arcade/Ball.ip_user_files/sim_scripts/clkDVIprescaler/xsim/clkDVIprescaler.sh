...
#
# Script generated by Vivado on Thu Dec 12 15:15:00 +0100 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clkDVIprescaler.sh
...
#
# Usage        : clkDVIprescaler.sh
#                clkDVIprescaler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clkDVIprescaler.sh [-reset_run]
#                clkDVIprescaler.sh [-reset_log]
#                clkDVIprescaler.sh [-help]
#
...
# script info
echo -e "clkDVIprescaler.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clkDVIprescaler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clkDVIprescaler xil_defaultlib.clkDVIprescaler xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clkDVIprescaler -key {Behavioral:sim_1:Functional:clkDVIprescaler} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clkDVIprescaler.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clkDVIprescaler.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clkDVIprescaler.sh [-help]\n\
Usage: clkDVIprescaler.sh [-step]\n\
Usage: clkDVIprescaler.sh [-lib_map_path]\n\
Usage: clkDVIprescaler.sh [-reset_run]\n\
Usage: clkDVIprescaler.sh [-reset_log]\n\
Usage: clkDVIprescaler.sh [-keep_index]\n\
Usage: clkDVIprescaler.sh [-noclean_files]\n\n\
