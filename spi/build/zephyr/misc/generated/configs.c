...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F091RC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F091RC_STM32F091XC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QUALIFIERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_STM32, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_STM32F0X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32F091XC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CPU_CORTEX_M0_HAS_VECTOR_TABLE_REMAP, 1);
