...
HD_PWD='C:/ProgH/SpiTest/SpiTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_16bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_slave_16bit.tcl -notrace
