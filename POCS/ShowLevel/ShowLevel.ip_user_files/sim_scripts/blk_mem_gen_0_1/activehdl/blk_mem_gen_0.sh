...
#
# Script generated by Vivado on Tue Mar 18 20:54:35 +0100 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Progh/Code/Project_RetroGame/POCS/ShowLevel/ShowLevel.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
