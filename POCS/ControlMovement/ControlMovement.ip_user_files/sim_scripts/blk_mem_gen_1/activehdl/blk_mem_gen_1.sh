...
#
# Script generated by Vivado on Mon Mar 17 11:54:33 +0100 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Progh/Code/Project_RetroGame/POCS/ShowCharacter/ShowLevel.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
