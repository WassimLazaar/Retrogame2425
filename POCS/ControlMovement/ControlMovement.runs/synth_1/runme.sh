...
HD_PWD='C:/Progh/Code/Project_RetroGame/POCS/ControlMovement/ControlMovement.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DVI_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DVI_Top.tcl
