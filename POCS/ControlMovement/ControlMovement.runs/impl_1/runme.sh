...
HD_PWD='C:/Progh/Code/Project_RetroGame/POCS/ControlMovement/ControlMovement.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DVI_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DVI_Top.tcl -notrace
